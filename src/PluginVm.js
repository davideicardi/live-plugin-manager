...
class PluginVm {
    ...
    runScript(code) {
        ...
        const pluginContext = new PluginInfo_1.PluginInfo(mainFile, location, PluginInfo_1.PluginName.parse(name), PluginInfo_1.PluginVersion.parse(version), VersionRef_1.parseVersionRef(version), []);
        try {
